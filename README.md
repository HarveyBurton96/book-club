...
![header](assets/images/Header.jpg)
        ...
        <li>
            ...
            <ul>
                <li>The sign up form has a background of a dark bookshelf with a blurring effect.</li>
...
<h2>Testing</h2>
    <ul>
        ...
        <p>I have tested this site across multiple virtual devices. I have also checked the site on iPhone, iPad, and a Samsung phone.</p>
        <li>
    ...
    <ul>
        ...
        <li>
            ...
            <ul>
                ...
                <li>Marcin-kli/MP1s README.md found at https://github.com/marcin-kli/MP1/blob/Milestone-Projects/README.md#new-user-goals</li>
            </ul> 
        <li>
            <p>Code</p>
        </li>
